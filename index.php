...
<body>
    ...
    <main>
        <div class="b-wrapper">
            ...
            <h1 data-aos="fade-up">¡Tu compra esta casi lista!</h1>

        </div>
    </main>

    <h3 data-aos="fade-up" class="adv">Para finalizar tu compra necesitamos que nos proporciones tus datos para verificar tu identidad</h3>
